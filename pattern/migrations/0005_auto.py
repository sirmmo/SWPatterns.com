...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field language on 'Use'
        db.create_table('pattern_use_language', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('use', models.ForeignKey(orm['pattern.use'], null=False)),
            ('language', models.ForeignKey(orm['pattern.language'], null=False))
        ))
        db.create_unique('pattern_use_language', ['use_id', 'language_id'])


    def backwards(self, orm):
        # Removing M2M table for field language on 'Use'
        db.delete_table('pattern_use_language')


    models = {
        'pattern.implementation': {
            'Meta': {'object_name': 'Implementation'},
            'file': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'pattern.use': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['pattern.Language']", 'null': 'True', 'blank': 'True'}),
