...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Implementation.file'
        db.add_column('pattern_implementation', 'file',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Implementation.file'
        db.delete_column('pattern_implementation', 'file')
